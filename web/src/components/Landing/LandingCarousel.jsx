...
const LandingCarousel = () => {
  return (
    <div className="carousel w-full">
      ...
      >
        <img src={"/photo3.jpg"} className="w-full h-screen" />
      ...
      <div
        ...
        className="carousel-item relative object-contain bg-center w-full h-full"
      >
        <img src={"/photo2.jpg"} className="w-full h-screen" />
        <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
          <a
            href="#slide1"
            className="btn btn-circle bg-transparent hover:bg-transparent text-white border-white w-12 h-10 xl:w-20 xl:h-20"
      ...
      <div
        ...
        className="carousel-item relative object-contain bg-center w-full h-full"
      >
        <img src={"/photo5.jpg"} className="w-full h-screen" />
        <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
          <a
            href="#slide2"
            className="btn btn-circle bg-transparent hover:bg-transparent text-white border-white w-12 h-10 xl:w-20 xl:h-20"
      ...
      <div
        ...
        className="carousel-item relative object-contain bg-center w-full h-full"
      >
        <img src={"/photo4.jpg"} className="w-full h-screen" />
        <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
          <a
            href="#slide3"
            className="btn btn-circle bg-transparent hover:bg-transparent text-white border-white w-12 h-10 xl:w-20 xl:h-20"
