    ...
    >
      <div className="cursor-pointer">
        <a
          ...
          className="text-white focus:text-white hover:text-orange-500"
        >
          <svg
        ...
        <p className="font-bold">Experience the magic of my basketball-infused codebase on GitHub!</p>
        <p className="mt-2">This is a non-commercial personal project</p>
        <p className="mt-2">ClutchPlay © 2023 - All right reserved</p>
      </div>
      <div>
