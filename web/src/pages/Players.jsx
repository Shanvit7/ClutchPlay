...
const Players = () => {
  ...
  return (
    <div className="w-screen h-screen bg-gray-50 overflow-x-hidden">
      <SideBarWrapper>
        <TopNavbar />
        <motion.h1 initial={{opacity:0}} animate={{opacity:1}} transition={{delay:0.1,ease:'easeInOut'}} className="text-black mt-20 ml-8">Know all about NBA Players</motion.h1>
        ...
        <div className="flex flex-col h-2/3 mt-8 2xl:h-min 2xl:mt-32 2xl:flex-row xl:h-min xl:flew-row xl:mt-32 lg:h-min lg:flex-row lg:mt-32 items-center justify-around w-full">
          <motion.div initial={{opacity:0}} animate={{opacity:1}} transition={{delay:0.2,ease:'easeInOut'}} className="card w-96 shadow-xl image-full before:custom-card">
            <figure>
