  ...
  return (
    <div className="w-screen h-screen bg-gray-50 overflow-x-hidden">
      <SideBarWrapper>
        ...
        <motion.h2 initial={{opacity:0}} animate={{opacity:1,scale:1.1}} transition={{delay:0.3,ease:'anticipate'}} className="text-xl text-black text-center lg:text-4xl xl:text-6xl mt-14">
          Catch all the NBA action here.
        </motion.h2>

        <motion.h3 className="text-black text-center mt-8" initial={{opacity:0}} animate={{opacity:1}} transition={{delay:0.4,ease:'backIn'}} >
         Games, Players, Stats and much more.
        </motion.h3>

        <motion.div className="flex justify-center mt-14 mb-14" initial={{opacity:0}} animate={{opacity:1}} transition={{delay:0.6,ease:'backInOut'}}>
          <img src={nbaLogo} className="w-24 h-24"/>
          <img src={lakersLogo} className="w-24 h-24"/>
        </motion.div>

        <motion.div className="hero bg-gray-50 mt-8" initial={{opacity:0}} animate={{opacity:1}} transition={{delay:0.8,ease:"easeInOut"}}>
